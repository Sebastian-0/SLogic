...
public class ModuleOutputType extends AbstractCircuitType
{
  ...
  {
    return new NameConfig("O-" + getId(component));
  }
  
  @Override
  public CircuitType makeCopy() {
    return new ModuleOutputType();
  }
  ...
  {
    return Table.get("circuit_module_out");
  }
}
