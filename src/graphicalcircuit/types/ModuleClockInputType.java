...
public class ModuleClockInputType extends AbstractCircuitType
{
  ...
  {
    return new NameConfig("CLK-" + getId(component));
  }
  
  @Override
  public CircuitType makeCopy() {
    return new ModuleClockInputType();
  }
  ...
  {
    return Table.get("circuit_module_clock");
  }
}
