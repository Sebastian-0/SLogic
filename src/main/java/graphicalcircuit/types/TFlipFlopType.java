...
import circuit.TFlipFlop;
import configuration.Table;

public class TFlipFlopType extends AbstractCircuitType
{
  ...
  public TFlipFlopType()
  {
    int WIDTH = TFlipFlopType.WIDTH + PIN_LENGHT*2;
  ...
  public CircuitType makeCopy() {
    return new TFlipFlopType();
  }
  
  @Override
  public Component makeBackendComponent(int id) {
    return new TFlipFlop(id);
  }
  ...
  {
    return "T " + Table.get("circuit_flip_flop");
  }
}
