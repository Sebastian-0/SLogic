...
import circuit.gates.OrGate;

public class OrGateType extends GateType
{
  public OrGateType(int numSlots)
  {
    super(numSlots);
  }
  ...
  protected CircuitType makeCopy(int numSlots) {
    return new OrGateType(numSlots);
  }
  
  @Override
  public Component makeBackendComponent(int id, int numSlots) {
    return new OrGate(id, numSlots);
  }
