...
public class DeletionToolMenuItem extends AbstractMenuItem implements Observer
{
  public DeletionToolMenuItem(ProgramUI window)
  {
    super(Table.get("menubar_deletion_tool"), window);
  ...
  {
    program.getBackend().getSession().getClient().getWorkspace().tool = ToolFactory.getTool(ToolFactory.Type.DELETE);
    program.repaint();
  }
}
