...
public class MoveToolMenuItem extends AbstractMenuItem implements Observer
{
  public MoveToolMenuItem(ProgramUI window)
  {
    super(Table.get("menubar_move_tool"), window);
  ...
  {
    program.getBackend().getSession().getClient().getWorkspace().tool = ToolFactory.getTool(ToolFactory.Type.MOVE);
    program.repaint();
  }
}
