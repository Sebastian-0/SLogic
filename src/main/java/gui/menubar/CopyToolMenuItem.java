...
public class CopyToolMenuItem extends AbstractMenuItem implements Observer
{
  public CopyToolMenuItem(ProgramUI window)
  {
    super(Table.get("menubar_copy_tool"), window);
  ...
  {
    program.getBackend().getSession().getClient().getWorkspace().tool = ToolFactory.getTool(ToolFactory.Type.COPY);
    program.repaint();
  }
}
