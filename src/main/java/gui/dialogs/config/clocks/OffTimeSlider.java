...
public class OffTimeSlider extends ValueSlider
{
  public OffTimeSlider()
  {
    super (10, 10000, 1000, Table.get("config_dialog_clocks_off_time"));
  }
  
  @Override
  protected int getValueFromNewClock(ClockConfig config)
  {
    return config.offTimeMillis;
  }

  @Override
  protected void valueChangedByUser(ClockConfig config, int newValue)
  {
    config.offTimeMillis = newValue;
  }
}
